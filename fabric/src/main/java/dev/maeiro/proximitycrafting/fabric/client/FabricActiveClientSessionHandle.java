...
public final class FabricActiveClientSessionHandle implements ActiveClientSessionHandle {
	private final ProximityCraftingScreen screen;

	public FabricActiveClientSessionHandle(ProximityCraftingScreen screen) {
		this.screen = screen;
	}
