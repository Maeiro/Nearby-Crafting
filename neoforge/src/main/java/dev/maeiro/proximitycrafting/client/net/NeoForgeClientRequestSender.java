...
public final class NeoForgeClientRequestSender implements ClientRequestSender {
	@Override
	...
	public void updateClientPreferences(int containerId, boolean autoRefillAfterCraft, boolean includePlayerInventory, String sourcePriority) {
		ProximityCraftingNetwork.CHANNEL.sendToServer(
				new C2SUpdateClientPreferences(containerId, autoRefillAfterCraft, includePlayerInventory, sourcePriority)
		);
	}
}
