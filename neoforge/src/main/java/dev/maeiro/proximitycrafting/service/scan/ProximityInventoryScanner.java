...
public final class ProximityInventoryScanner implements SourceCollector {
	private static final ContainerDiscoveryPort CONTAINER_DISCOVERY_PORT = new NeoForgeContainerDiscoveryPort();
	...
	private static final NeoForgePlayerInventorySourceCollector PLAYER_INVENTORY_SOURCE_COLLECTOR = new NeoForgePlayerInventorySourceCollector();
	private static final NeoForgeBackpackSourceCollector BACKPACK_SOURCE_COLLECTOR = new NeoForgeBackpackSourceCollector();
