...
public final class NeoForgeActiveClientSessionHandle implements ActiveClientSessionHandle {
	private final ProximityCraftingScreen screen;

	public NeoForgeActiveClientSessionHandle(ProximityCraftingScreen screen) {
		this.screen = screen;
	}
